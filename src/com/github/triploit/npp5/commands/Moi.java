...
public class Moi
{
	...
	{
//		 System.out.println("MOI gefunden!");
//		
...
//		 }
		...
		{
			Err.printErr("[ ERR ]:[ MOI ]:[ NOTFOUND:" + var.getName() + " ] Variable konnte nicht gefunden werden!");
			System.exit(0);
		}
		else
		{
			...
			{
				Err.printErr("[ ERR ]:[ MOI ]:[ VALUE ] Der eingegebene Wert ist kein Integer-Wert oder die Variable ist kein Integer!");				
				System.exit(0);
			}
		}
	}
